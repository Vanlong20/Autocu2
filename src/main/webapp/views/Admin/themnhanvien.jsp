...
<body>
                    ...
                    <form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control" id="diaChiEmail">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
    ...
    document.querySelector('form').addEventListener('submit', function (event) {
        ...
        const email = document.getElementById('diaChiEmail').value.trim();
        ...
        // Nếu có lỗi, ngăn gửi biểu mẫu và hiển thị thông báo
        if (hasError) {
            event.preventDefault();
            alert(errorMessage);
        }
